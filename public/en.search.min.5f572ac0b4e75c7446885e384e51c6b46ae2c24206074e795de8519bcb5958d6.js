...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/~slaberge/flexsearch.min.js');loadScript('/~slaberge/en.search-data.min.add10348d7e6a33772ef9a7ec015791a26096fb14028ab462ca3a73f2efaa79b.js',function(){input.required=false;search();});}
