...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/~slaberge/flexsearch.min.js');loadScript('/~slaberge/en.search-data.min.182a888c1975e0300dba48cc95ae498955fff92de3546b171a1ac3656861a94a.js',function(){input.required=false;search();});}
