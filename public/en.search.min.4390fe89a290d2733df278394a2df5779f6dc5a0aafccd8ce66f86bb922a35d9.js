...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/~slaberge/flexsearch.min.js');loadScript('/~slaberge/en.search-data.min.e7bca1a317d2a1737656a708159ce2dc95c65a4b90f68067bceae9537c942042.js',function(){input.required=false;search();});}
