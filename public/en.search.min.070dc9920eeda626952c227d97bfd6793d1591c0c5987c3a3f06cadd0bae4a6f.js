...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/~slaberge/flexsearch.min.js');loadScript('/~slaberge/en.search-data.min.ff696e6c991a56c0429fbf6b18dd3ba637f1817f9d4054a183bdd763a060d326.js',function(){input.required=false;search();});}
