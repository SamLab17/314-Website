...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/~slaberge/flexsearch.min.js');loadScript('/~slaberge/en.search-data.min.4e0d615aac2e2b52238fcd20c913383d47e1796cb3be1326bb5d8e0c489952a1.js',function(){input.required=false;search();});}
