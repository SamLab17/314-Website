...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/~slaberge/flexsearch.min.js');loadScript('/~slaberge/en.search-data.min.8fe658e20cd87fe75014fabb0fb99653a144e6024026df358270f9ed1c294b92.js',function(){input.required=false;search();});}
