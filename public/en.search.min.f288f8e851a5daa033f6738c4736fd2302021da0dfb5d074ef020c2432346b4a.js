...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/~slaberge/flexsearch.min.js');loadScript('/~slaberge/en.search-data.min.8b0756645f75860a0d81f4dcae02b5e206913460b0a6be253880694a0318cfd9.js',function(){input.required=false;search();});}
