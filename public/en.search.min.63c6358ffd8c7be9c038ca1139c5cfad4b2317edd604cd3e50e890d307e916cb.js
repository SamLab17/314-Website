...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/~slaberge/flexsearch.min.js');loadScript('/~slaberge/en.search-data.min.a88351f22be12b80ed2d8c11bdb8178e98f6d37f10f9e704479144e797d49d9a.js',function(){input.required=false;search();});}
